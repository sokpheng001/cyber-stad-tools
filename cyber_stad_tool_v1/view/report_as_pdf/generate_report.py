...
class Report(ABC):
    ...
    def generate_report(self):
        ...
        if self.data == '':  # false
            ...
            bar_fig = px.bar(x=bar_chart_labels, y=bar_chart_data, color=bar_chart_labels,
            ...
            pdf.image(str(bar_chart_image_path), x=None, y=None, w=pdf.w * 0.7, h=0, type='PNG',
                      link=str(bar_chart_image_path))
