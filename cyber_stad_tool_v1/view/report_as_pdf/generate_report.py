...
class Report(ABC):
    ...
    ("Contact", ["For inquiries, contact 087524805"])
            ...
            vulnerabilities_data = {             
             ...
             # Add the following line before generating the charts
            ...
            bar_fig.write_image(bar_chart_image_path, format='png')
...
# Call func
# report = Report()
# generated_report_path = report.generate_report()
#
# if generated_report_path:
#     print(f"Report saved at: {generated_report_path}")
# else:
