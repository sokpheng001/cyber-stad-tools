...
def start_banner(banner_text="REPORT"):
    ...
    print("[" + Fore.GREEN + "***" + Style.RESET_ALL + "] " + "Report Started:", formatted_datetime);
    ...
    print(banner)
    print("================================================================================");
    # print("                       . This the pen-testing report");
    print("               Report Started:", formatted_datetime);
